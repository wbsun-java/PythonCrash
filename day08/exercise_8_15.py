...
#
# This exercise: put those functions in a separate file called printing_functions.py
# Then import and use them here in exercise_8_15.py.
#
# Step 1: Create printing_functions.py with both functions
# Step 2: In this file, add: from printing_functions import print_models, show_completed_models
