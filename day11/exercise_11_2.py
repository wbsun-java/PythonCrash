...
# Modify city_country() to require a 3rd parameter: population.
# It should now return: "City, Country – population xxx"
# e.g., "Santiago, Chile – population 5000000"
#
# Steps:
...
# TODO: Run: python test_cities.py — both tests should pass
